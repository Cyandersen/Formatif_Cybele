...
* Author: cy.andersen
* Date: Oct. 30, 2020
* Description: Ce programme calculera vos impôts en fonction de votre Revenu Brut, 
* Contributions don de bienfaisance et revenu imposable, il tient compte des restrictions et va Afficher le montant de l’impôt total à payer 
* dans un mode uniforme. Ce programme calculera vos impôts en fonction de la formule précise Impot basée sur des pourcentages
*/

public class ImpotCybèleAvecSeulmentLesPourcentage
{
	...
	public static void main(String[] args)
	{
		...
		if(mRevenuimposable>210371)
			mImpôtAPayer=mRevenuimposable*0.33;
		else
			if(mRevenuimposable>=147667)
				mImpôtAPayer=mRevenuimposable*0.29;
			else
				if(mRevenuimposable>=95259)
					mImpôtAPayer=mRevenuimposable*0.26;
				else
					if(mRevenuimposable>=47630)
						mImpôtAPayer=mRevenuimposable*0.205;
					else
